...
class AdminServices {
  ...
  Future<void> changeOrderStatus({
    ...
    try {
      ...
      showSnackBar(context, e.toString());
      rethrow; // Thêm throw để báo lỗi cho caller
    }
  }
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            ...
            Sales(label: 'Essentials', earnings: response['essentialEarnings']),
            Sales(label: 'Books', earnings: response['booksEarnings']),
            Sales(label: 'Appliances', earnings: response['applianceEarnings']),
