...
class AuthService {
  ...
  Future<void> _handleAuthSuccess(
    ...
    try {
      ...
      final routeName = userProvider.user.type == 'user'
          ? BottomBar.routeName
      ...
      _showSnackBar(context, 'Có lỗi xảy ra: ${e.toString()}', isError: true);
    }
  }
...
Future<void> resetPassword({
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final errorMsg = jsonDecode(response.body)['msg'] ?? 'Đặt lại mật khẩu thất bại';
      _showSnackBar(context, errorMsg, isError: true);
    }
  } catch (e) {
    _showSnackBar(context, e.toString(), isError: true);
